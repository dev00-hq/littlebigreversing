...
Generated by:
  python tools/codex_memory.py briefing --task 'held forward viewer gameplay locomotion seam'

Source hash:
  sha256:b1a44fa4213795d3a163159ca66459c2b3980d15db43dd0f5d65d285c8ec0eea
-->

## Task

held forward viewer gameplay locomotion seam
...
Selected because: tag token match `gameplay`; body token match `forward`, `held`, `locomotion`, `seam`, `viewer`
