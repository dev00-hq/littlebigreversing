...
- Build future viewer-local refinement on the landed `11/10` fragment comparison prioritization and selected-cell detail strip rather than replacing the viewer-local snapshot path, and keep it away from gameplay, life binding, exterior loading, or a full room-art renderer.
