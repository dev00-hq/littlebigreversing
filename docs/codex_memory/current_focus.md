...
- Gameplay/runtime widening outside the guarded `19/19` baseline remains blocked on unsupported switch-family life and the lack of checked-in life execution support.
