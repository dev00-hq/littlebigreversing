...
- Port `187/187` zone `1` no-readjust cube `185` rejects decoded landing `(13824,5120,14848)` as a height mismatch. Live run4, without `SceneStart` sync, lands at `(28416,2304,21760)` from saved `StartCube=(55,11,44)` context; do not admit the decoded position as the live handoff.
