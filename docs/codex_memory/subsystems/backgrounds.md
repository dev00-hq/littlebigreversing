...
- `187/187` zone `1` no-readjust cube `185` maps to `187/187` but rejects as `unsupported_destination_height_mismatch`; landing cell `27/29` has raw surface `2048`, top `6400`.
