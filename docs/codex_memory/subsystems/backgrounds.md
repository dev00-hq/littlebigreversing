...
- Port `187/187` zone `1` no-readjust cube `185` rejects decoded landing `(13824,5120,14848)` as a height mismatch at cell `27/29`; live run2 lands cube `185` at `(28416,2304,21760)`, which still needs a port geometry/admission explanation.
