...
- The live render path now owns the viewer-local HUD/legend for pairing metadata, focus state, comparison semantics, and explicit `2/2` zero-fragment messaging.
