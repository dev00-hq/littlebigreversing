...
- `0013` key pickup is Frida poll-only proved: `SPRITE_CLE` from `(3072,3072,5120)`, `Divers=1`, `NbLittleKeys 0 -> 1`; port ticks default-action spawn, pickup, and both doors.
