...
LOAD_GAME_POST_ADELINE_MENU_DELAY_SEC = 2.0
LOAD_GAME_MAIN_MENU_MOVE_DELAY_SEC = 1.0
LOAD_GAME_MENU_SETTLE_DELAY_SEC = 2.0
LOAD_GAME_SOLE_SAVE_SETTLE_DELAY_SEC = 5.0
SCENE11_POST_ADELINE_MENU_DELAY_SEC = 2.0
SCENE11_MAIN_MENU_MOVE_DELAY_SEC = 1.0
SCENE11_LOAD_MENU_SETTLE_DELAY_SEC = 2.0
SCENE11_LOAD_MENU_SELECT_CURRENT_STEPS = 4
SCENE11_CURRENT_SETTLE_DELAY_SEC = 5.0
